          ...
          <SectionCard title="Личная информация">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <p>
                  <strong>Имя:</strong> [Ваше имя]
                </p>
                <p>
                  <strong>Возраст:</strong> [Ваш возраст]
                </p>
                <p>
                  <strong>Специальность:</strong> [Ваша специальность]
                </p>
                <p>
                  <strong>Курс:</strong> [Ваш курс]
                </p>
              </div>
            </div>
          </SectionCard>
